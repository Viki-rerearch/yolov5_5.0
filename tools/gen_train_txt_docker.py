...
if __name__ == "__main__":
    ...
    parser.add_argument('--input_dir',nargs='+', default=['/home/wk/docker/yolov5-5.0/data/yaoping'],
                        help='dateset absolute path')
    parser.add_argument('--output_dir', type=str, default=r'/home/wk/docker/yolov5-5.0/data',
